...
class MLAlgorithm(models.Model):
    ...
    Attributes:
         ...
         parent_endpoint: The reference endpoint to the Endpoint.
...
class MLAlgorithmStatus(models.Model):
    ...
    '''
    The MLAlgorithmStatus represent the Status of the ML Algorithm which can change during the time.
    ...
    Attributes:
         ...
         parent_endpoint: The reference corresponding MLAlgorithm.
